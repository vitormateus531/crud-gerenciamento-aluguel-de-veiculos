...
| Uri | Tipo | Valores 
| ------ | ------ | ---------|
| /aluguel-veiculos | GET | exibe view e retorna lista de veículos alugados. |
...
| /controle-veiculos | GET | exibi view e retorna lista de veículos cadastrados.|
